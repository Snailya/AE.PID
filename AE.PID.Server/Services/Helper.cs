...
public class Helper
{
    ...
    /// <returns></returns>
    internal static IEnumerable<DetailedLibraryItemDto> PopulatesCheatSheetItems(AppDbContext dbContext,
        bool involvePreRelease = false)
    {
        ...
        foreach (var library in dbContext.Libraries)
        {
            ...
            items.AddRange(dbContext.Entry(version).Collection(x => x.LibraryVersionItems)
