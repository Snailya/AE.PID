...
public class MaterialsViewModel : ViewModelBase
{
    ...
    public ObservableCollection<ByGroupViewModel> GroupDescriptions { get; set; } = [];
    ...
    public ReactiveCommand<ByGroupViewModel?, Unit> AddGroupDescription { get; }
    public ReactiveCommand<ByGroupViewModel?, Unit> RemoveGroupDescription { get; set; }
    ...
    )
    {
        ...
        AddGroupDescription = ReactiveCommand.Create<ByGroupViewModel?>(groupDescription =>
        {
        ...
        RemoveGroupDescription = ReactiveCommand.Create<ByGroupViewModel?>(groupDescription =>
        {
            if (groupDescription == null || string.IsNullOrEmpty(groupDescription.PropertyName)) return;
