...
[ElectricalControlSpecificationItem("5.阀类设备", "4.2 风阀", [BaseIdDict.Damper])]
public class Damper : ElectricalControlSpecificationItemBase
{
    public override Type Type { get; } = typeof(Damper);
