...
public class LibraryUpdater
{
    ...
    public LibraryUpdater(HttpClient client, ConfigurationService configuration)
    {
        ...
        var autoCheckObservable = configuration
            ...
            .Do(_ => _logger.Info("Library Update started. {Initiated by: Auto-Run}"));

        var userCheckObservable =
            ManuallyInvokeTrigger
                .Do(_ => _logger.Info("Library Update started. {Initiated by: User}"));
    ...
    {
        _logger.Info("Try getting library infos from server.");
        ...
        {
            _logger.Error(e, "Failed to get libraries from server.");
        }
    ...
    private async Task DownloadCheatSheet()
    {
        ...
        {
            _logger.Error(e, "Failed to download cheatsheet from server.");
        }
    }
