    ...
    private class PartListTableLineItem
    {
        ...
        public static PartListTableLineItem FromPartItem(PartItem x)
        {
            return new PartListTableLineItem
            {
                ...
                MaterialNo = x.DesignMaterial.Value?.MaterialNo ?? string.Empty,
                Description = x.Description,
                Specification = x.DesignMaterial.Value?.Specifications ?? string.Empty,
                TechnicalDataChinese = x.DesignMaterial.Value?.TechnicalData ?? string.Empty,
                TechnicalDataEnglish = x.DesignMaterial.Value?.TechnicalDataEnglish ?? string.Empty,
                Total = x.SubTotal,
                InGroup = x.SubTotal,
                Count = x.SubTotal,
                Unit = x.DesignMaterial.Value?.Unit ?? string.Empty,
                Supplier = x.DesignMaterial.Value?.Supplier ?? string.Empty,
                ManufacturerMaterialNo = x.DesignMaterial.Value?.ManufacturerMaterialNumber ?? string.Empty,
                Type = x.DesignMaterial.Value?.Type ?? string.Empty,
